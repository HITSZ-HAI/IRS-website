...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
    ["vendors-node_modules_github_remote-form_dist_index_js-node_modules_delegated-events_dist_inde-c537341", "vendors-node_modules_github_catalyst_lib_index_js-node_modules_github_hydro-analytics-client_-978abc0", "vendors-node_modules_github_catalyst_lib_index_js-node_modules_github_hydro-analytics-client_-978abc1", "vendors-node_modules_github_remote-form_dist_index_js-node_modules_delegated-events_dist_inde-c537340", "vendors-node_modules_github_remote-form_dist_index_js-node_modules_delegated-events_dist_inde-c537342", "vendors-node_modules_delegated-events_dist_index_js-node_modules_github_catalyst_lib_index_js-b4a243", "vendors-node_modules_github_catalyst_lib_index_js-node_modules_github_hydro-analytics-client_-978abc2", "vendors-node_modules_delegated-events_dist_index_js-node_modules_github_catalyst_lib_index_js"], {
        65935: (e, t, n) => {
            ...
            function c(e, t) {
                o || (o = new Map, "undefined" != typeof document && document.addEventListener("submit", d));
                let n = o.get(e) || [];
                o.set(e, [...n, t])
            }
            ...
            function d(e) {
                ...
                let a = function(e) {
                    ...
                    [l, c, d] = r();
                e.preventDefault(), u(n, t, a, l).then(async e => {
                    if (e) {
                        for (let e of s) await e(t);
                        f(a).then(c, d).catch(() => {}).then(() => {
                            for (let e of i) e(t)
                        })
                    } else t.submit()
                }, e => {
        ...
        59753: (e, t, n) => {
            ...
            function u(e, t) {
                var n, o, r, i, s, a, l = (e = e.slice(0).concat(e.default)).length,
                    c = t,
                    u = [];
                do
            ...
            o.prototype.logDefaultIndexUsed = function() {}, o.prototype.add = function(e, t) {
                var n, o, i, s, a, l, c, d, f = this.activeIndexes,
                    h = this.selectors,
                ...
                if ("string" == typeof e) {
                    for (o = 0, p[(n = {
                            ...
                            selector: e,
                            data: t
                        }).id] = n, c = u(this.indexes, e); o < c.length; o++) s = (d = c[o]).key, (a = function(e, t) {
                        var n, o, r;
                        for (n = 0, o = e.length; n < o; n++)
                            if (r = e[n], t.isPrototypeOf(r)) return r
                    }(f, i = d.index)) || ((a = Object.create(i)).map = new r, f.push(a)), i === this.indexes.default && this.logDefaultIndexUsed(n), (l = a.map.get(s)) || (l = [], a.map.set(s, l)), l.push(n);
                    this.size++, h.push(e)
                }
            }, o.prototype.remove = function(e, t) {
                if ("string" == typeof e) {
                    var n, o, r, i, s, a, l, c, d = this.activeIndexes,
                        f = this.selectors = [],
                        ...
                        for (o = n[r], i = d.length; i--;)
                            if (a = d[i], o.index.isPrototypeOf(a)) {
                                if (l = a.map.get(o.key))
                                    for (s = l.length; s--;)(c = l[s]).selector === e && (m || c.data === t) && (l.splice(s, 1), p[c.id] = !0);
                                break
                            }
                ...
                for (t = 0, o = u.length; t < o; t++)
                    for (n = 0, i = u[t], r = (s = this.matches(i)).length; n < r; n++) c[(l = s[n]).id] ? a = c[l.id] : (a = {
                        id: l.id,
                        selector: l.selector,
                        data: l.data,
                        elements: []
                    }, c[l.id] = a, d.push(a)), a.elements.push(i);
                return d.sort(f)
            }, o.prototype.matches = function(e) {
                if (!e) return [];
                var t, n, o, r, i, s, a, l, c, d, u, h = this.activeIndexes,
                    p = {},
                    m = [];
                for (t = 0, r = h.length; t < r; t++)
                    if (l = (a = h[t]).element(e)) {
                        for (n = 0, i = l.length; n < i; n++)
                            if (c = a.map.get(l[n]))
                                for (o = 0, s = c.length; o < s; o++) !p[u = (d = c[o]).id] && this.matchesSelector(e, d.selector) && (p[u] = !0, m.push(d))
                    }
                return m.sort(f)
            };
            var h = {},
            ...
            function E(e) {
                if (function(e) {
                    ...
                    if (t) {
                        ...
                        if (n.length) {
                            w(e, "stopPropagation", v), w(e, "stopImmediatePropagation", _), A(e, x);
                            for (var o = 0, r = n.length; o < r && !m.get(e); o++) {
                                var i = n[o];
                                b.set(e, i.node);
                                for (var s = 0, a = i.observers.length; s < a && !g.get(e); s++) i.observers[s].data.call(i.node, e)
                            }
                            b.delete(e), A(e)
                        }
                    }
            ...
            function S(e, t, n) {
                var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                    ...
                    s = i ? p : h,
                    a = s[e];
                a || (a = new o, s[e] = a, document.addEventListener(e, E, i)), a.add(t, n)
            }
            ...
            function k(e, t, n) {
                var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                    ...
                    i = r ? p : h,
                    s = i[e];
                s && (s.remove(t, n), s.size || (delete i[e], document.removeEventListener(e, E, r)))
            }
        ...
        76006: (e, t, n) => {
            ...
            let CatalystDelegate = class CatalystDelegate {
                constructor(e) {
                    ...
                    Object.defineProperty(e, "observedAttributes", {
                        ...
                        function(e) {
                            ...
                            Object.defineProperty(e, "observedAttributes", {
                                configurable: !0,
                                get: () => [...w(e.prototype, p)].map(o).concat(t),
                                set(e) {
                                    t = e
                                }
                            })
                ...
                connectedCallback(e, t) {
                    ...
                    }(e), b(e), r.add(e), e.shadowRoot && (a(o = e.shadowRoot), s(o)), a(e), s(e.ownerDocument), t ? .call(e), e.shadowRoot && (a(n = e.shadowRoot), s(n))
                }
            ...
            function O(e, t) {
                A.has(e) || A.set(e, new Set), A.get(e).add(t), C(document.body), o || (o = new MutationObserver(e => {
                    if (A.size)
                        for (let t of e)
