    ...
    ["vendors-node_modules_github_filter-input-element_dist_index_js-node_modules_github_mini-throt-08ab15", "vendors-node_modules_github_catalyst_lib_index_js-node_modules_github_hydro-analytics-client_-978abc0", "vendors-node_modules_github_catalyst_lib_index_js-node_modules_github_hydro-analytics-client_-978abc1", "vendors-node_modules_github_catalyst_lib_index_js-node_modules_github_hydro-analytics-client_-978abc2"], {
        13002: (e, t, n) => {
            ...
            let FilterInputElement = class FilterInputElement extends HTMLElement {
                constructor() {
                    ...
                    }(() => r(this, !0)), this.boundFilterResults = () => {
                        r(this, !1)
                    }
                }
            ...
            async function r(e, t = !1) {
                ...
                if (!n) return;
                let r = n.value.trim(),
                    i = e.getAttribute("aria-owns");
                if (!i) return;
                let a = document.getElementById(i);
                if (!a) return;
                let l = a.hasAttribute("data-filter-list") ? a : a.querySelector("[data-filter-list]");
                if (!l || (e.dispatchEvent(new CustomEvent("filter-input-start", {
                        bubbles: !0
                    })), t && e.currentQuery === r)) return;
                e.currentQuery = r;
                let s = e.filter || o,
                    u = l.childElementCount,
                    c = 0,
                    d = !1;
                for (let e of Array.from(l.children)) {
                    ...
                    let t = function(e) {
                        ...
                        n = s(e, t, r);
                    !0 === n.hideNew && (d = n.hideNew), e.hidden = !n.match, n.match && c++
                }
                let f = a.querySelector("[data-filter-new-item]"),
                    h = !!f && r.length > 0 && !d;
                f instanceof HTMLElement && (f.hidden = !h, h && function(e, t) {
                    ...
                    }(a, c > 0 || h), e.dispatchEvent(new CustomEvent("filter-input-updated", {
                        bubbles: !0,
                        detail: {
                            count: c,
                            total: u
        ...
        46263: (e, t, n) => {
            function r(e, t = 0, {
                ...
                function s(...u) {
                    if (l) return;
                    let c = Date.now() - a;
                    a = Date.now(), n ? (n = !1, e.apply(this, u), o && s.cancel()) : (r && c < t || !r) && (clearTimeout(i), i = setTimeout(() => {
                        a = Date.now(), e.apply(this, u), o && s.cancel()
                    }, r ? t - c : t))
                }
                return s.cancel = () => {
                    clearTimeout(i), l = !0
        ...
        65935: (e, t, n) => {
            ...
            function c(e) {
                ...
                let l = function(e) {
                    ...
                    [s, u, c] = o();
                e.preventDefault(), d(n, t, l, s).then(async e => {
                    if (e) {
                        for (let e of a) await e(t);
                        f(l).then(u, c).catch(() => {}).then(() => {
                            for (let e of i) e(t)
                        })
                    } else t.submit()
                }, e => {
        ...
        88309: (e, t, n) => {
            ...
            async function o(e, t) {
                ...
                if (!u) return;
                let c = new URL(s, window.location.href),
                    d = new URLSearchParams(c.search);
                d.append(e.getAttribute("param") || "q", l), c.search = d.toString(), a.controller ? a.controller.abort() : (e.dispatchEvent(new CustomEvent("loadstart")), e.setAttribute("loading", "")), a.controller = "AbortController" in window ? new AbortController : {
                    signal: null,
                    abort() {}
                };
                let f = "";
                try {
                    n = await i(e, c.toString(), {
                ...
                n && n.ok ? (u.innerHTML = f, e.dispatchEvent(new CustomEvent("remote-input-success", {
                    bubbles: !0
            ...
            async function i(e, t, n) {
                try {
                    ...
                    throw "AbortError" !== t.name && (e.dispatchEvent(new CustomEvent("error")), e.dispatchEvent(new CustomEvent("loadend"))), t
                }
            }
        ...
        47142: (e, t, n) => {
            ...
            function i(e, t, n, o) {
                for (var i = e.length, a = t.length, l = e.toLowerCase(), s = t.toLowerCase(), u = function(e) {
                        for (var t = e.length, n = Array(t), r = "/", o = 0; o < t; o++) {
                            var i, a = e[o];
                            "/" === r ? n[o] = .9 : "-" === r || "_" === r || " " === r ? n[o] = .8 : "." === r ? n[o] = .6 : (i = r).toLowerCase() === i && a.toUpperCase() === a ? n[o] = .7 : n[o] = 0, r = a
                        }
                        return n
                    }(t, u), c = 0; c < i; c++) {
                    n[c] = Array(a), o[c] = Array(a);
                    for (var d = r, f = c === i - 1 ? -.005 : -.01, h = 0; h < a; h++)
                        if (l[c] === s[h]) {
                            var m = r;
                            c ? h && (m = Math.max(o[c - 1][h - 1] + u[h], n[c - 1][h - 1] + 1)) : m = -.005 * h + u[h], n[c][h] = m, o[c][h] = d = Math.max(m, d + f)
                        } else n[c][h] = r, o[c][h] = d += f
                }
            }
            ...
            function l(e, t) {
                ...
                for (var c = !1, l = n - 1, d = o - 1; l >= 0; l--)
                    for (; d >= 0; d--)
                        if (s[l][d] !== r && (c || s[l][d] === u[l][d])) {
                            c = l && d && u[l][d] === s[l - 1][d - 1] + 1, a[l] = d--;
                            break
                        }
                return a
            }
        ...
        76006: (e, t, n) => {
            ...
            function a(e = document) {
                ...
                let t = !1,
                    n = new MutationObserver(e => {
                        for (let t of e)
                            if ("attributes" === t.type && t.target instanceof Element) c(t.target);
            ...
            function c(e) {
                for (let t of u(e)) e.addEventListener(t.type, s)
            }
            ...
            function g(e, t) {
                ...
                for (let o of (t || (t = y(n, m)), t)) {
                    ...
                    }), Object.defineProperty(e, o, i), o in e && !e.hasAttribute(n) && i.set.call(e, t)
                }
            }
            let w = Symbol.for("catalyst");
            let CatalystDelegate = class CatalystDelegate {
                constructor(e) {
                    ...
                    Object.defineProperty(e, "observedAttributes", {
                        ...
                        function(e) {
                            ...
                            Object.defineProperty(e, "observedAttributes", {
                                configurable: !0,
                                get: () => [...y(e.prototype, m)].map(r).concat(t),
                                set(e) {
                                    t = e
                                }
                            })
                ...
                connectedCallback(e, t) {
                    ...
                    }(e), g(e), o.add(e), e.shadowRoot && (l(r = e.shadowRoot), a(r)), l(e), a(e.ownerDocument), t ? .call(e), e.shadowRoot && (l(n = e.shadowRoot), a(n))
                }
                    ...
                    for (let t of C.keys()) {
                        ...
                        if (customElements.get(t) || n) {
                            let r = n ? .getAttribute("data-load-on") || "ready",
                                o = r in x ? x[r] : x.ready;
                            for (let e of C.get(t) || []) o(t).then(e);
            ...
            function T(e, t) {
                C.has(e) || C.set(e, new Set), C.get(e).add(t), S(document.body), r || (r = new MutationObserver(e => {
                    if (C.size)
                        for (let t of e)
...
//# sourceMappingURL=vendors-node_modules_github_filter-input-element_dist_index_js-node_modules_github_mini-throt-08ab15-74eb3802a260.js.map