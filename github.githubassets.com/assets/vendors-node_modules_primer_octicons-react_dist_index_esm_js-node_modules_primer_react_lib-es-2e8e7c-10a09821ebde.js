    ...
    ["vendors-node_modules_primer_octicons-react_dist_index_esm_js-node_modules_primer_react_lib-es-2e8e7c"], {
        ...
        41905: (e, a, t) => {
            ...
            let h = ({
                ...
                if (!h.current) {
                    ...
                    e.style.position = "relative", e.style.zIndex = "1", h.current = e
                }
                let f = h.current;
                return (0, c.Z)(() => {
                    let e = t;
                    ...
                    return r.appendChild(f), null == a || a(), () => {
                        r.removeChild(f)
                    }
                }, [f]), (0, n.createPortal)(e, f)
            }
        },
        8386: (e, a, t) => {
            "use strict";
                ...
                u = ({
                    ...
                    let {
                        ...
                        return r.useEffect(() => {
                            ...
                            if (r) {
                                let e = r.matches;
                                if (a(n(e)), void 0 !== r.addEventListener) return r.addEventListener("change", c),
                                    function() {
                                        r.removeEventListener("change", c)
                                    };
                                if (void 0 !== r.addListener) return r.addListener(c),
                                    function() {
                                        r.removeListener(c)
                                    }
                            }
        ...
        72774: (e, a, t) => {
            ...
            let {
                ...
                mono: p.fontStack(["var(--fontStack-monospace)", "SFMono-Regular", "Consolas", "Liberation Mono", "Menlo", "Courier", "monospace"])
