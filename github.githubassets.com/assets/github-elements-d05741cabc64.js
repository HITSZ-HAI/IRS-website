...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
    ["github-elements"], {
        10361: (e, t, i) => {
            i(60084), i(38257), i(14840), i(57260), i(13002), i(73921);
            var n, s = i(27034);
            ...
            let g = class MarkedTextElement extends HTMLElement {
                ...
                connectedCallback() {
                    this.handleEvent(), this.ownerInput ? .addEventListener("input", this), h(this, m, new MutationObserver(() => this.handleEvent()))
                }
                handleEvent() {
                    u(this, f) && cancelAnimationFrame(u(this, f)), h(this, f, requestAnimationFrame(() => this.mark()))
                }
                ...
                mark() {
                    let e = this.textContent || "",
                        t = this.query;
                    if (e === u(this, c) && t === u(this, p)) return;
                    h(this, c, e), h(this, p, t), u(this, m).disconnect();
                    let i = 0,
            ...
            let F = class VirtualFilterInputElement extends HTMLElement {
                ...
                get filtered() {
                    ...
                    if (this.hasAttribute("aria-owns")) {
                        ...
                        e && (e instanceof Set || e && "object" == typeof e && "size" in e && "add" in e && "delete" in e && "clear" in e) && R(this, W, e)
                    }
                    return R(this, W, I(this, W) || new Set)
                }
                set filtered(e) {
                    R(this, W, e)
                }
                ...
                reset() {
                    this.filtered.clear(), R(this, H, new Set)
                }
                clear() {
                ...
                attributeChangedCallback(e, t, i) {
                    let n = this.isConnected && this.src,
                        ...
                        r = t !== i;
                    ("src" === e || "data-property" === e) && r && (R(this, z, null), I(this, N) && clearTimeout(I(this, N))), n && s && ("src" === e || "loading" === e || "accept" === e || "data-property" === e) && r ? (cancelAnimationFrame(I(this, O)), R(this, O, requestAnimationFrame(() => this.load()))) : "aria-owns" === e && R(this, W, null)
                }
                connectedCallback() {
                    this.src && "eager" === this.loading && (cancelAnimationFrame(I(this, O)), R(this, O, requestAnimationFrame(() => this.load())));
                    let e = this.input;
                    if (!e) return;
                ...
                handleEvent(e) {
                    "input" === e.type && (I(this, N) && clearTimeout(I(this, N)), R(this, N, window.setTimeout(() => this.filterItems(), (this.input ? .value ? .length, 300))))
                }
                async load() {
                    I(this, j) ? .abort(), R(this, j, new AbortController);
                    let {
                        signal: e
                    } = I(this, j);
                    ...
                    if (await new Promise(e => setTimeout(e, 0)), !e.aborted) {
                        ...
                        try {
                            ...
                            R(this, H, new Set((await t.json())[this.property])), R(this, z, null), this.dispatchEvent(new Event("loadend"))
                        } catch (t) {
                            if (e.aborted) {
                ...
                constructor(...e) {
                    super(...e), P(this, j, {
                        ...
                        writable: !0,
                        value: void 0
                    }), R(this, O, 0), R(this, z, null), R(this, H, new Set), R(this, W, null), this.filter = (e, t) => String(e).includes(t)
                }
            };
                ...
                et = class VirtualListElement extends HTMLElement {
                    ...
                    updateSync() {
                        ...
                        for (let [e, t] of s) {
                            ...
                            c = c || n >= p, D(this, G).set(e, i)
                        }
                        let m = !o && this.size > s.size;
                        if (m && !c) return D(this, X).delete(`${this.scrollTop}-${this.getBoundingClientRect().height}`), this.update();
                ...
                d = class FuzzyListElement extends HTMLElement {
                    ...
                    sort() {
                        ...
                        let {
                            items: p,
                            lazyItems: m
                        } = c, f = this.hasAttribute("mark-selector"), g = this.querySelector("ul");
                        if (!g) return;
                        let v = [];
                        if (h) {
                            for (let e of p) {
                            ...
                            let i = 0,
                                s = () => {
                                    ...
                                    for (let e = i; e < a; e += 1) {
                                        ...
                                        i instanceof HTMLElement && (f && r(n && i.querySelector(n) || i, f ? h : "", u(i)), o.appendChild(i))
                                    }
                                    i = a;
                                    let d = !1;
        ...
        22490: (e, t, i) => {
            ...
            let a = {
                    createHTML: r("createHTML"),
                    createScript: r("createScript"),
                    createScriptURL: r("createScriptURL")
                },
                o = new Map,
...
//# sourceMappingURL=github-elements-fbe90346863c.js.map