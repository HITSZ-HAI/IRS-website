...
const getMnemonicFor = (item) => {
    var _a;
    return (_a = item.textContent) === null || _a === void 0 ? void 0 : _a.trim()[0].toLowerCase();
};
const printable = /^\S$/;
class FocusGroupElement extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const {
            signal
        } = __classPrivateFieldGet(this, _FocusGroupElement_abortController, "f");
    ...
    handleEvent(event) {
        ...
        if (event.type === 'focusin') {
            if (this.retain && event.target instanceof Element && event.target.matches(menuItemSelector)) {
                ...
                const {
                    signal
                } = (__classPrivateFieldSet(this, _FocusGroupElement_retainSignal, new AbortController(), "f"));
