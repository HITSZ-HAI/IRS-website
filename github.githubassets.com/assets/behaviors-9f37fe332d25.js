    ...
    ["behaviors"], {
        4294: (e, t, n) => {
            ...
            function R(e) {
                ...
                s && (s.id || (s.id = a()), M.set(s, s.innerHTML)), e.addEventListener("loadstart", () => {
            ...
            function et(e, t = !1) {
                ...
                add(e) {
                    (0, Z.Z)(e) && Y(e), e.addEventListener("change", function() {
                        Y(e)
                    })
                }
            ...
            let eM = (e, t, n, r, i, a) => {
                    ...
                    if (s === t || s === n) return s;
                    let l = ex(e, s);
                    return i > l.top + l.height ? eM(e, s + 1, n, r, i, a + 1) : i < l.top ? eM(e, t, s - 1, r, i, a + 1) : 3 > l.xDistance(r) ? s : l.left < r ? 0 !== ex(e, s + 1).checkLine(i) ? s : eM(e, s + 1, n, r, i, a + 1) : l.left > r ? 0 !== ex(e, s - 1).checkLine(i) ? s : eM(e, t, s - 1, r, i, a + 1) : s
                },
                e_ = (e, t, n) => {
                    let r = e.value.length;
                    return eM(e, 0, r, t, n, 0)
                };
            var eR = n(49421);
            let eN = new Map;
...
`
            ...
            }), ts(), document.addEventListener(ti.Q.SUCCESS, ts), window.matchMedia("(prefers-color-scheme: dark)").addListener(() => {
            ...
            }(0, tJ.Z)(tQ), (0, w.on)("click", 'a[href^="#"]', function(e) {
                let {
                    currentTarget: t
                } = e;
                t instanceof HTMLAnchorElement && setTimeout(tQ, 0)
            ...
            function t2(e) {
                ...
                constructor: t4.Z,
                subscribe: e => (0, F.RB)(e, "fuzzy-list-sorted", t7)
            ...
            var t9 = n(29764);
            let t3 = document.querySelector(".js-hovercard-content");
            ...
            function ni() {
                t3 instanceof HTMLElement && (t3.style.display = "none", t3.children[0].textContent = "", t3.removeAttribute("data-hovercard-target-url"), t8 = null, a = null)
            }
            async function na(e, t) {
                ...
                i === a && n && (! function(e, t) {
                    ...
                    n.appendChild(r),
                        function(e, t) {
                            if (!(t3 instanceof HTMLElement)) return;
                            t3.style.visibility = "hidden", t3.style.display = "block", t.classList.remove(nr("bottom-left"), nr("bottom-right"), nr("right-top"), nr("right-bottom"), nr("top-left"), nr("top-right"));
                            let {
                                containerTop: n,
                                containerLeft: r,
                            ...
                            t.classList.add(nr(i)), t3.style.top = `${n+window.pageYOffset}px`, t3.style.left = `${r+window.pageXOffset}px`,
                                function(e, t) {
                                    let n = e.getAttribute("data-hovercard-z-index-override");
                                    n ? t.style.zIndex = n : t.style.zIndex = "100"
                                }(e, t3), t3.style.visibility = ""
                        }(t, n), setTimeout(() => {
                            if (document.body && document.body.contains(r)) {
                                let e = r.querySelector("[data-hydro-view]");
                                e instanceof HTMLElement && (0, t9.Fk)(e)
                            }
                        }, 500), (0, C.N)(r), t3.style.display = "block", t3.setAttribute("data-hovercard-target-url", t.getAttribute("data-hovercard-url") || "")
                }(n, i), e instanceof KeyboardEvent && t3 instanceof HTMLElement && t3.focus())
            }
            ...
            async function nx() {
                window.performance && window.performance.timing && window.performance.getEntriesByType && (await ea.C, await new Promise(e => setTimeout(e)), nM(), n_())
            }
            let nM = () => {
            ...
            nx(), (0, np.mw)(nC), (0, np.a4)(nC), (0, np.Fu)(nC), (0, np.NO)(nC), (0, np.mr)(nC), (0, np.Yn)(nC);
            ...
            function nH({
                ...
                let n, r, i;
                nR.abort(), nR = new AbortController;
                    ...
                    l = new MutationObserver(i => {
                        ...
                        if (!i.every(e => 0 === e.addedNodes.length)) {
                            ...
                            s ? (window.performance.measure("HPC", "navigationStart"), l.disconnect(), r = requestAnimationFrame(() => {
                                o.dispatchEvent(new HPCTimingEvent(e, (0, L.cF)(), nA(), nT(), t, !0, nq(), nk(), a))
                ...
                o.addEventListener("hpc:dom-insertion", () => {
                    d = !0, clearTimeout(i);
                    let n = new HPCTimingEvent(e, (0, L.cF)(), nA(), nT(), t, !1, nq(), nk(), a);
                    i = setTimeout(() => o.dispatchEvent(n), 1e4)
                }, {
                    signal: nR.signal
                }), o.addEventListener("hpc:timing", e => {
                    !s && e.value < 6e4 && nC(e), nR.abort()
                }, {
                    signal: nR.signal
                }), nR.signal.addEventListener("abort", () => {
                    ...
                    d || nN(e, !1)
                }, 1e4), !e && document.querySelector("[data-hpc]") && (nN(e, !0), nR.abort())
            }
            async function nP() {
                ...
                let e = Array.from(document.querySelectorAll("img.js-img-time")).slice(0, 5),
                    t = Date.now(),
                    n = [];
                await Promise.all(e.map(e => n$(e, t, n))), n.length > 0 && (0, q.b)({
            ...
            document.addEventListener(ti.Q.START, ({
                mechanism: e
            }) => {
                nH({
                    soft: !0,
                ...
                document.addEventListener(ti.Q.FRAME_UPDATE, () => (0, E.YT)({
                    turbo: "true"
                })), document.addEventListener(ti.Q.SUCCESS, () => {
                    "turbo.frame" !== (0, nw.Gj)() && (0, E.YT)({
                        turbo: "true"
                    })
                }), await ea.C, (0, E.YT)()
            ...
            function nO() {
                ...
                constructor: HTMLInputElement,
                add(e) {
                    e.addEventListener("focusin", nO, {
                        once: !0
                    }), (0, nD.Nc)(window.location.pathname)
                }
            });
            let nB = !1;
            async function nW() {
            ...
            function nF(e) {
            ...
            }(0, w.on)("click", ".js-keyboard-shortcuts", nW), (0, nv.c)("react_keyboard_shortcuts_dialog") || document.addEventListener("keydown", e => {
                !(e instanceof KeyboardEvent) || !(0, e9.Zf)(e) || e.target instanceof Node && (0, P.sw)(e.target) || "Shift+?" !== (0, t5.EL)(e) || nW()
                ...
                add(e) {
                    e.addEventListener("input", nF), e.addEventListener("change", nF)
                },
                remove(e) {
                    e.removeEventListener("input", nF), e.removeEventListener("change", nF)
                }
            ...
            let nU = null,
                nz = "last_turbo_request",
                nV = "turbo_start",
                nX = "turbo_end";
            async function nG() {
                if (await (0, O.gJ)(), !window.performance.getEntriesByName(nV).length) return;
                window.performance.mark(nX), window.performance.measure(nz, nV, nX);
                let e = window.performance.getEntriesByName(nz),
                    t = e.pop(),
                    n = t ? t.duration : null;
                n && (nU && (0, q.b)({
                    requestUrl: nU,
                    turboDuration: Math.round(n)
                }), window.performance.clearMarks(nV), window.performance.clearMarks(nX), window.performance.clearMeasures(nz))
            }
            "getEntriesByName" in window.performance && (document.addEventListener("turbo:before-fetch-request", function(e) {
                e instanceof CustomEvent && e.detail ? .url && !e.defaultPrevented && (window.performance.mark(nV), nU = e.detail.url)
            }), document.addEventListener("turbo:render", nG)), (0, T.N7)("body.js-print-popup", () => {
...
${r}\`\`\``, i
            ...
            (0, w.on)("click", ".js-comment-quote-reply", function({
                ...
                if (s.hasAttribute("data-quote-markdown") && (r = new nZ.I(s.getAttribute("data-quote-markdown") || "", e => {
                        ...
                        if (n instanceof HTMLElement) {
                            ...
                            let t = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT, {
                                    acceptNode: e => e.nodeName in nJ && ("IMG" === e.nodeName || null != e.firstChild) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
                                }),
                                n = [],
                                r = t.nextNode();
                            for (; r;) r instanceof HTMLElement && n.push(r), r = t.nextNode();
                            for (let e of (n.reverse(), n)) e.replaceWith(nJ[e.nodeName](e))
                        }(e)
            ...
            function n1(e) {
                ...
                e.preventDefault(), nY(e)
            }), (0, w.on)("toggle", ".js-reaction-popover-container", function(e) {
                let t = e.currentTarget.hasAttribute("open");
                for (let n of e.target.querySelectorAll(".js-reaction-option-item")) t ? (n.addEventListener("mouseenter", n0), n.addEventListener("mouseleave", n1)) : (n.removeEventListener("mouseenter", n0), n.removeEventListener("mouseleave", n1))
            }, {
                capture: !0
            });
            var n4 = n(5582);
            ...
            (0, w.on)("click", ".js-markdown-link-button", async function({
                ...
                e instanceof HTMLElement && n7.set(r, e.closest("markdown-toolbar").field.selectionEnd)
            ...
            (0, w.on)("click", ".js-saved-reply-menu.ActionListWrap", function(e) {
                ...
                if ("Control+." === (0, t5.EL)(e)) {
                    ...
                    n instanceof n2.F ? n.show() : n.setAttribute("open", ""), e.preventDefault()
                }
            ...
            function n3(e, t, n, r) {
                let i = (0, n5.M9)(e, e => t.querySelector(`#LC${e}`));
                if (!i) return;
                if (n) {
                ...
                a.classList.add(...["text-bold", "hx_keyword-hl", "rounded-2", "d-inline-block"]), (0, n9.v)(i, a)
            ...
            function ri(e, t) {
                ...
                (0, S.AC)(".js-notification-shelf .js-notification-action form", async function(e, t) {
                    ...
                    if (n) {
                        ...
                        e && e.click();
                        return
                    }(0, re.a)(e, e), await rt(t)
                })
            })(), rn(), document.addEventListener(ti.Q.SUCCESS, rn), document.addEventListener("turbo:before-fetch-request", function(e) {
                let t = (0, n6.I)(e.detail.url.pathname);
                if (t) {
            ...
            }), document.addEventListener(ti.Q.SUCCESS, rr), rr(), (0, B.w4)("keyup", ".js-site-search-field", function(e) {
                let t = e.target,
                    n = 0 === t.value.length;
                n && "Backspace" === e.key && t.classList.contains("is-clearable") && ri(t, !1), n && "Escape" === e.key && ri(t, !0), t.classList.toggle("is-clearable", n)
                ...
                t.classList.add("focus"), e.addEventListener("blur", function n() {
                    t.classList.remove("focus"), 0 === e.value.length && e.classList.contains("js-site-search-field") && ri(e, !0), e.removeEventListener("blur", n)
                })
            ...
            let rl = new WeakMap,
                rc = document.querySelector("#snippet-clipboard-copy-button"),
                ru = document.querySelector("#snippet-clipboard-copy-button-unpositioned");
            ...
            function rm(e, t, n) {
                rf(e, t), n && e.classList.toggle("on");
            ...
            function rf(e, t) {
                ...
                try {
                    n = await t.json(), r && (await rm(r, n.json.count, i), function(e) {
                        let t;
                    ...
                    if (t.response ? .status === 409 && t.response.json.confirmationDialog) {
                        ...
                        if (a instanceof HTMLTemplateElement && o) {
                            ...
                            s.addEventListener("social-confirmation-form:success", async e => {
                                e instanceof CustomEvent && r && await rm(r, e.detail.count, i)
            ...
            L.n4 ? .addEventListener("visibilitychange", () => {
                ...
                void 0 !== u && clearTimeout(u), u = setTimeout(() => {
                    if (e !== rb)
                        for (let t of (rb = e, u = void 0, rg)) t(rb)
                }, e ? 3e4 : 0)
            }), async function() {
                let e = await (0, rh.G)();
                if (!e) return;
                ...
                (0, T.N7)(".js-socket-channel[data-channel]", {
                    subscribe: e => {
                        ...
                        let i = (function(e) {
                                ...
                                return t.map(rp.Topic.parse).filter(ry)
                            })(e).map(t => ({
                                subscriber: e,
                                topic: t
                            })),
                            a = i.map(e => e.topic.name).filter(e => (0, rp.A)(e)),
                            o = {
                                unsubscribe() {}
                            };
                        if (a.length) {
                            ...
                            o = (0, F.qC)((0, F.RB)(e, "socket:set-presence-metadata", e => {
                                ...
                                t = e, s()
                            })(rb), rg.push(n), new F.w0(() => {
                                let e = rg.indexOf(n); - 1 !== e && rg.splice(e, 1)
                            })))
                        }
                        return t(i), o
                    },
            ...
            if ("function" == typeof BroadcastChannel) try {
                (rw = new BroadcastChannel("stale-session")).onmessage = e => {
                    "string" == typeof e.data && rv(e.data)
                }
            } catch {}
            if (!rw) {
                let e = !1;
                rw = {
                    ...
                    if (!e && t.storageArea === window.localStorage && "logged-in" === t.key) try {
                        ("SIGNED_IN" === t.newValue || "SIGNED_OUT" === t.newValue || t.newValue ? .startsWith("SWITCHED")) && rv(t.newValue)
                    } finally {
                        window.localStorage.removeItem(t.key)
                    }
                })
            }
            let rS = document.querySelector(".js-stale-session-flash[data-signedin]");
            if (rS) {
                let e = rS.getAttribute("data-signedin") || "";
                rw ? .postMessage(e)
            }
            let rE = () => {
                rw ? .postMessage("false")
            };
            ...
            async function rj(e) {
                ...
                t && (i.replaceWith(t), r.querySelector(".js-details-container").classList.add("open"), n && r.classList.contains("js-append-menu-to-body") && rL(document.body, r, n))
            }
            ...
            function rA(e) {
                ...
                n && (t.addEventListener("toggle", r), n.classList.contains("js-close-menu-on-scroll") && window.addEventListener("scroll", i, {
                    capture: !0
                }), n.classList.remove("d-none"), n.querySelector(".js-details-container").classList.add("open"), n.classList.contains("js-append-menu-to-body") && (document.body.appendChild(n), rL(document.body, n, t)))
            }, {
                capture: !0
                ...
                add(e) {
                    e.addEventListener("mouseenter", rA, {
                        once: !0
                    })
                },
                remove(e) {
            ...
            async function rM(e, t) {
                let [n, r] = await rR(e), i = (function(e, t) {
            ...
            async function r_(e) {
                ...
                return [n, [...n.children]]
            }(0, w.on)("click", "button[data-sudo-required], summary[data-sudo-required]", rq), (0, T.N7)("form[data-sudo-required]", {
                constructor: HTMLFormElement,
                subscribe: e => (0, F.RB)(e, "submit", rq)
            }), (0, T.N7)("text-expander[data-emoji-url]", {
                subscribe: e => (0, F.qC)((0, F.RB)(e, "text-expander-change", rC), (0, F.RB)(e, "text-expander-value", rk), (0, F.RB)(e, "text-expander-activate", rx))
            });
            let rR = (0, eZ.Z)(r_);
            var rN = n(45974);
    ...
    >
      ...
      <li class="markdown-title" role="option" id="suggester-issue-${e.id}" data-value="${e.number}">
        ...
        <small>#${e.number}</small> ${(0,rN.Au)(e.title)}
      </li>
    `})}
    </ul>
  `, t)
            ...
            function rB(e) {
                ...
                0 > ["ArrowRight", "ArrowLeft"].indexOf(t) || rD(e.target)
            }
            async function rW(e, t, n) {
                let r = await rz(e, t, n),
                    i = document.createElement("div");
                rP(r.matches, i, r.icons, t);
                ...
                subscribe: e => {
                    let t = [(0, F.RB)(e, "text-expander-change", rI), (0, F.RB)(e, "text-expander-value", r$), (0, F.RB)(e, "keydown", rB), (0, F.RB)(e, "click", rO)];
                    return (0, F.qC)(...t)
                }
            });
            let rF = new Set,
            ...
            async function rV(e, t, n) {
                ...
                let i = await rX(r.toString());
                if (rU.set(t, i), rF.delete(t), rU.size > 5) {
                    let e = rU.size - 5,
                        t = Array.from(rU.keys()).slice(0, e);
                    for (let e of t) rU.delete(e)
                }
  ...
  `, r);
                ...
                subscribe: e => (0, F.qC)((0, F.RB)(e, "text-expander-change", rK), (0, F.RB)(e, "text-expander-value", rZ))
            });
            let rQ = (0, eZ.Z)(async function(e) {
                let t = await self.fetch(e, {
                    headers: {
                        "X-Requested-With": "XMLHttpRequest",
                        Accept: "application/json"
            ...
            async function r0(e) {
                ...
                try {
                    0 === i.total ? i.members.push("This team has no members") : i.total > i.members.length && i.members.push(`${i.total-i.members.length} more`), r1(o, function(e) {
            ...
            function r2(e = !0) {
                ...
                if (n) ie(n);
                    ...
                    if (function(e) {
                            let t = r9(e, ".js-comment-container");
                            return !!t && ((0, nI.$)(t), !0)
                        }(t) || r5(t, ".js-thread-hidden-comment-ids") || r5(t, ".js-review-hidden-comment-ids")) return;
            ...
            document.addEventListener("keydown", e => {
                ...
                let t = document.querySelector(".js-targetable-element:target");
                !(!t || e.target instanceof HTMLAnchorElement) && e.target instanceof HTMLElement && (t.contains(e.target) || (0, rY.uQ)(t, () => {
                    window.location.hash = "", (0, I.lO)(window.history.state, "", window.location.pathname + window.location.search)
                }))
            }), n(48804), (0, T.N7)(".js-team-mention", function(e) {
                e.addEventListener("mouseenter", r0)
                ...
                r2()
            }), (0, T.N7)(".js-timeline-progressive-focus-container", r7), window.addEventListener("sticky-header-rendered", () => {
                r7()
            ...
            var ia = n(67852),
                io = n(23243),
                is = n(78923);
            (0, ia.E_)(is.w), (0, ia.OY)(0), ia.session.isVisitable = () => !0;
            let il = Object.getOwnPropertyDescriptor(ia.cr.prototype, "reloadReason").get;
            ...
            Object.defineProperty(ia.cr.prototype, "reloadReason", {
                get() {
                    let e = il.call(this);
                    if ("tracked_element_mismatch" !== e.reason) return e;
                    let t = Object.fromEntries(ic(this.currentHeadSnapshot)),
                        n = [];
                    for (let [e, r] of ic(this.newHeadSnapshot)) t[e] !== r && n.push((0, io.T2)(e));
                    return {
            ...
            let iu = e => {
                ...
                history[e] = function(n, r, i) {
                    ...
                    ia.ry.history.update(function(r, i, o) {
            ...
            iu("replaceState"), iu("pushState");
            let id = ia.session.adapter,
                im = () => {
                    id.progressBar.setValue(0), id.progressBar.show()
                },
                ih = () => {
                    id.progressBar.setValue(1), id.progressBar.hide()
                };
            var ip = n(78806);
            let ig = new Map,
                ib = new Map,
                iy = () => ig.get(document.location.href),
                iv = (e, t) => ig.set(e, t),
                iw = () => ib.set(document.location.href, (0, io.Yg)()),
                iS = () => ib.get(document.location.href);
            (async () => {
                await ea.x, iv(document.location.href, (0, io.ag)(document)), iw()
            })();
            var iE = n(75214);
            let iL = !1,
                ij = null;
            L.iG && (0, T.N7)("[data-turbo-frame]", {
                ...
                if (e.target instanceof HTMLElement && e instanceof CustomEvent) {
                    if (nv.c("disable_turbo_visit") && !nw.sj() || ip.Z(location.href, e.detail.url)) {
                        e.preventDefault();
                        return
                    }
                    e.defaultPrevented || iE.LD("turbo")
                }
            }), L.n4 ? .addEventListener("turbo:before-fetch-request", function(e) {
                let t = window.onbeforeunload ? .(e);
                if (t) {
                    let n = confirm(t);
                    n ? window.onbeforeunload = null : (e.preventDefault(), ih())
                }
            }), L.n4 ? .addEventListener("turbo:before-fetch-request", e => {
                if (e.defaultPrevented) return;
                let t = e.target;
                io.HN(t) && im(), t ? .tagName === "HTML" && (e.detail.fetchOptions.headers["Turbo-Visit"] = "true")
            });
            let iA = L.n4 ? .createElement("turbo-frame"),
                iT = Object.getPrototypeOf(iA.delegate),
                iq = iT.requestErrored;
            iT.requestErrored = function(e, t) {
                ...
                if (iL = t.statusCode >= 500, 404 === t.statusCode && (io.uL(t.statusCode), window.location = t.location, e.preventDefault()), history.replaceState({ ...history.state,
                        skipTurbo: !1
                    }, "", location.href), iL) {
                    let e = await t.responseHTML,
                        n = is.w.createHTML(e, t.response);
                    ij = new DOMParser().parseFromString(n, "text/html")
                }
            }), L.n4 ? .addEventListener("turbo:frame-render", e => {
                io.HN(e.target) && ih()
            }), L.n4 ? .addEventListener("turbo:before-render", async e => {
                e instanceof CustomEvent && (e.preventDefault(), e.detail.render = iC, await io.q3(), e.detail.resume(!0), io.Ap(document.documentElement, e.detail.newBody.ownerDocument.documentElement), iw())
            });
            let ik = () => new Promise(e => {
                    setTimeout(() => e(), 0)
                }),
                iC = async (e, t) => {
                    if (await ik(), iL && ij) {
                        for (let e of (document.documentElement.replaceWith(ij.documentElement), document.querySelectorAll("script"))) {
                            let t = (0, io.lL)(e);
                            t && e.replaceWith(t)
                        }
                        return
                    ...
                    n && r ? ((0, io.Ap)(e, t), n.replaceWith(r)) : ((0, io.uL)("missing_turbo_body"), window.location.reload())
                };
            ...
            let iM = !1,
                i_ = e => {
                    ...
                    return n && t && !(0, io.AU)(r.pathname, location.pathname) || i && !(0, io.ck)(r.pathname, location.pathname)
                };
            L.n4 ? .addEventListener("turbo:frame-click", function(e) {
                if (e.target instanceof HTMLElement && e instanceof CustomEvent) {
                    if (ip.Z(location.href, e.detail.url)) {
                        e.preventDefault();
                        return
                    }
                    i_(e) && (io.uL("repo_mismatch"), e.target.removeAttribute("data-turbo-frame"), e.preventDefault()), e.defaultPrevented || iE.LD("turbo.frame")
                }
            }), L.n4 ? .addEventListener("turbo:before-fetch-response", e => {
                d = e.detail.fetchResponse, io.HN(e.target) && iv(window.location.href, io.ag(document))
                ...
                let r = await d.responseHTML,
                    i = d.location,
                    a = is.w.createHTML(r, d.response),
                ...
                let s = e.target,
                    ...
                    u = io.po(o);
                if (!c || u.length > 0) {
                    io.uL(`tracked_element_mismatch-${u.join("-")}`), window.location = i;
                    return
                }
                iv(i.href, io.ag(o)), io.DT(o), io.xk(o), io.wz(o), i$(s, c), await io.q3(), t(), iI(n) && window.scrollTo(0, 0), iR(o)
            }), L.iG ? .addEventListener("popstate", () => {
                document.addEventListener("turbo:load", () => {
                    let e = iy() ? .replacedElements || [];
                    io.wz(document, e)
                }, {
                    once: !0
                })
            }), L.n4 ? .addEventListener(ti.Q.SUCCESS, () => {
                iN(), iM && (iM = !1, iH(), iP(), iE.u5())
            });
            let iR = e => {
                ...
                iI = e => "true" !== e.getAttribute("data-turbo-skip-scroll") && "advance" === e.getAttribute("data-turbo-action");
            L.n4 ? .addEventListener("turbo:frame-load", e => {
                nw.sj() && nw.U6("turbo.frame"), iE.TL({
                    skipIfGoingToReactApp: !0,
                    allowedMechanisms: ["turbo.frame"]
                }), e.target instanceof HTMLElement && "advance" !== e.target.getAttribute("data-turbo-action") && iE.BT({
                    skipIfGoingToReactApp: !0,
                    allowedMechanisms: ["turbo.frame"]
                })
                ...
                !nw.sj() || t || nw.OE() ? t && (nw.OE() || nw.sj()) ? iE.r_({
                    skipIfGoingToReactApp: !0,
            ...
            }), L.n4 ? .addEventListener("beforeunload", () => iE.FP()), L.n4 ? .addEventListener("turbo:reload", function(e) {
                e instanceof CustomEvent && nw.Ak(e.detail.reason)
            }), L.n4 ? .addEventListener(ti.Q.END, iw), L.n4 ? .addEventListener(ti.Q.PROGRESS_BAR.START, im), L.n4 ? .addEventListener(ti.Q.PROGRESS_BAR.END, ih), window.requestIdleCallback(() => {
                let e = function() {
            ...
            let iG = (p = new WeakMap, (g = class SudoCredentialOptionsElement extends HTMLElement {
                connectedCallback() {
                    let e = this.initialState;
                    iV(this, p, e), this.reRenderPrompt(!0)
                }
                reRenderPrompt(e = !1) {
                    this.resetPrompt();
                    try {
                ...
                handleUnexpectedPromptError(e) {
                    ...
                    if (e && "password" !== iz(this, p)) throw this.renderPasswordOptionWithError(t), e
                }
                ...
                reRenderNavContainer() {
                    this.isWebAuthnAvailable() && "webauthn" !== iz(this, p) && this.safeSetElementVisibility(this.webauthnNav, !0), this.isGitHubMobileAvailable() && "github_mobile" !== iz(this, p) && this.safeSetElementVisibility(this.githubMobileNav, !0), this.isTotpAppAvailable() && "app" !== iz(this, p) && this.safeSetElementVisibility(this.totpAppNav, !0), this.isTotpSmsAvailable() && "sms" !== iz(this, p) && this.safeSetElementVisibility(this.totpSmsNav, !0), "password" !== iz(this, p) && this.safeSetElementVisibility(this.passwordNav, !0)
                }
                renderWebauthnOption() {
                    this.safeSetElementVisibility(this.webauthnContainer, !0), this.webauthnGet ? .setState(iW.Zh() ? iO.State.Ready : iO.State.Unsupported)
                }
                ...
                showWebauthn() {
                    iV(this, p, "webauthn"), this.reRenderPrompt()
                }
                showGitHubMobile() {
                    iV(this, p, "github_mobile"), this.reRenderPrompt()
                }
                showTotpApp() {
                    iV(this, p, "app"), this.reRenderPrompt()
                }
                showTotpSms() {
                    iV(this, p, "sms"), this.reRenderPrompt()
                }
                showPassword() {
                    iV(this, p, "password"), this.reRenderPrompt()
                }
                githubMobileRetry(e) {
                ...
                async initiateGitHubMobileAuthRequest() {
                    ...
                    try {
                        ...
                        if (!t.ok && "github_mobile" === iz(this, p)) {
                        ...
                        (0, iB.Hu)(a, () => this.mobileApprovedHandler(), e => this.mobileFailHandler(e), () => this.mobileCancelCheck())
                    } catch (e) {
                        "github_mobile" === iz(this, p) && this.mobileFailHandler(this.githubMobileGenericErrorMessage)
                    } finally {
                        "github_mobile" === iz(this, p) && (this.safeSetElementVisibility(this.githubMobileLoading, !1), this.safeSetElementVisibility(this.githubMobileContainer, !0))
                    }
                }
                async resendTotpSms() {
                    this.hideErrorMessage(), (0, iF.C)();
                    try {
                ...
                async initiateTotpSmsRequest(e = !1) {
                    ...
                    try {
                        ...
                        if (n.ok || "sms" !== iz(this, p)) "sms" === iz(this, p) && e && (0, iF.v)();
                        else {
                            let e = await n.json();
                            this.showErrorMessage(e.error)
                        }
                    } catch (e) {
                        "sms" === iz(this, p) && this.showErrorMessage(this.smsGenericErrorMessage)
                    }
                    "sms" === iz(this, p) && this.safeSetElementVisibility(this.totpSmsResendNav, !0)
                }
                mobileApprovedHandler() {
                    if ("github_mobile" === iz(this, p)) {
                        let e = this.githubMobileContainer.getElementsByTagName("form")[0];
                        (0, P.Bt)(e)
                    }
                }
                mobileFailHandler(e) {
                    "github_mobile" === iz(this, p) && (this.showErrorMessage(e), (0, iB.cj)())
                }
                mobileCancelCheck() {
                    return "github_mobile" !== iz(this, p)
                }
            ...
            function iJ(e) {
                ...
                remove(e) {
                    iZ--, iK && iK.unobserve(e), 0 === iZ && function() {
                ...
                subscribe: e => (0, F.RB)(e, "socket:message", function(e) {
                    ...
                    if (t.getAttribute("data-channel-target") === n.gid)
                        for (let e of document.querySelectorAll(".js-unread-item")) iJ(e)
                })
            });
            let iQ = 0,
                iY = /^\(\d+\)\s+/;
            ...
            function i0() {
                let e = iQ ? `(${iQ}) ` : "";
                document.title.match(iY) ? document.title = document.title.replace(iY, e) : document.title = `${e}${document.title}`
            }
            async function i1() {
            ...
            function i7() {
                if (!(0, i4.l)() || document.querySelector(":target")) return;
                let e = (0, rs.$z)(location.hash),
                    t = e.startsWith("user-content-") ? e : `user-content-${e}`,
                    n = (0, rs.Q)(document, t) ? ? (0, rs.Q)(document, t.toLowerCase());
                n && (0, tK.zT)(n)
            }
            async function i2() {
                await n.e("app_assets_modules_github_user-status-submit_ts").then(n.bind(n, 47455))
            }
            window.addEventListener("hashchange", i7), document.addEventListener("turbo:load", i7), async function() {
                await ea.x, i7()
            ...
            function ao(e, t) {
            ...
            }), (0, B.q6)(".js-user-list-form input", i3), (0, B.q6)(".js-user-list-form textarea", i3), (0, w.on)("auto-check-error", ".js-user-list-form input", function(e) {
                ...
                n.json.didCreate ? await i8() : r && await (0, ey.x0)(r), (0, w.f)(e, "user-list-menu-form:success")
                ...
                add(e) {
                    e.addEventListener("input", ae), e.addEventListener("change", ae), e.addEventListener("submit", at);
                    let t = e.closest("details-dialog");
                    t && (t.closest("details").addEventListener("toggle", an), t.addEventListener("details-dialog-close", ar))
                },
                remove(e) {
                    e.removeEventListener("input", ae), e.removeEventListener("change", ae), e.removeEventListener("submit", at);
                    let t = e.closest("details-dialog");
                    t && (t.closest("details").removeEventListener("toggle", an), t.removeEventListener("details-dialog-close", ar), at())
                }
            }), (0, T.N7)(".will-transition-once", {
                constructor: HTMLElement,
                subscribe: e => (0, F.RB)(e, "transitionend", ai)
            }), (0, T.N7)(".js-issue-link", {
                subscribe: e => (0, F.RB)(e, "mouseenter", aa)
            });
            var as = n(12085),
                al = n.n(as);
            ...
            function af(e, t) {
                am(".js-label-name-error", e, t.name), am(".js-label-description-error", e, t.description), am(".js-label-color-error", e, t.color)
            }

            function ah(e) {
                am(".js-label-name-error", e, null), am(".js-label-description-error", e, null), am(".js-label-color-error", e, null)
            }
            async function ap(e) {
                let t;
                ...
                try {
                    ...
                    af(r, e), i && (i.textContent = e.message, i.hidden = !1);
                    return
                }
                i && (i.textContent = "", i.hidden = !0), ah(r), o.textContent = "", o.appendChild(t), n.setAttribute("data-last-preview-url", d)
            }
            ...
            async function ay(e) {
                ...
                au(i, al().hex.rgb(r)), (0, ec.Qc)(t), ap(n);
                ...
                e.reset(), ah(e), document.querySelector(".js-label-list").prepend(n.html), ab(1), ag(e, !1);
                let r = e.querySelector(".js-new-label-color"),
                    i = ac();
                ad(r, i), ap(e.querySelector(".js-new-label-name-input")), (0, ec.Qc)(e);
            ...
            function aS(e, t, n, r) {
                ...
                if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) o = Reflect.decorate(e, t, n, r);
                    ...
                    for (var s = e.length - 1; s >= 0; s--)(i = e[s]) && (o = (a < 3 ? i(o) : a > 3 ? i(t, n, o) : i(t, n)) || o);
                return a > 3 && o && Object.defineProperty(t, n, o), o
            }(0, w.on)("suggester:complete", ".js-new-label-name-input", av), (0, B.q6)(".js-new-label-name-input", av), (0, B.q6)(".js-new-label-description-input", av), (0, B.q6)(".js-new-label-color-input", av), (0, B.w4)("keypress", ".js-new-label-name-input", function(e) {
                let t = e.target,
                ...
                capture: !0
            }), (0, w.on)("change", ".js-thread-notification-setting", aw), (0, w.on)("change", ".js-custom-thread-notification-option", aw), (0, w.on)("reset", ".js-custom-thread-settings-form", aw);
            let aE = class CollapsibleSidebarWidgetElement extends HTMLElement {
                get activeClass() {
            ...
            aS([iD.fA], aE.prototype, "collapsible", void 0), aE = aS([iD.Ih], aE);
            let aj = ((y = class SidebarMemexInputElement extends HTMLElement {
                get isDisabled() {
            ...
            aL([iD.Lj], aj.prototype, "updateUrl", void 0), aL([iD.Lj], aj.prototype, "csrfToken", void 0), aL([iD.Lj], aj.prototype, "instrumentType", void 0), aL([iD.Lj], aj.prototype, "columnId", void 0), aL([iD.GO], aj.prototype, "inputs", void 0), aL([iD.fA], aj.prototype, "read", void 0), aL([iD.fA], aj.prototype, "write", void 0), aL([iD.GO], aj.prototype, "parameters", void 0), aj = aL([iD.Ih], aj);
            var aA = n(98973);
            ...
            function aT(e, t = !1) {
                (t || ! function(e) {
                    ...
                    let n = [...document.querySelectorAll(".js-reviewer-team")].map(e => e.getAttribute("data-id")),
                        r = e instanceof HTMLFormElement ? new FormData(e) : aP(e),
                    ...
                    return aH(e, `${t}?${o}`), !0
                }(e)) && (e instanceof HTMLFormElement ? (0, P.Bt)(e) : aR(e))
            }
            ...
            function ak(e, t) {
                ...
                if (t.hasAttribute("data-clear-assignees")) {
                    ...
                    aT(r)
                } else i ? n.closest("details").addEventListener("toggle", aq, {
                    once: !0
                }) : aT(r)
            }, {
                capture: !0
                ...
                try {
                    let n = await t.html(),
                        ...
                        a = r ? .parentElement;
                    r.replaceWith(n.html), a && i && ak(a, i)
                } catch (e) {
            ...
            async function ax(e, t) {
                ...
                try {
                    for (let t of (await aN(e), a)) t.remove()
                } catch (e) {
                    aC.delete(n)
                }
            }
            ...
            function aP(e) {
                ...
                add(e) {
                    ...
                    ax(e, t), window.addEventListener("pagehide", () => a_(e, t)), window.addEventListener("turbo:before-visit", () => a_(e, t)), window.addEventListener("submit", e => {
                        e.defaultPrevented || (aM = !0, setTimeout(() => {
                            for (let e of Object.keys(sessionStorage)) - 1 !== e.indexOf(t) && (sessionStorage.removeItem(e), aC.clear())
                        }, 0))
                    }, {
                        capture: !0
                    })
            ...
            L.n4 ? .addEventListener(ti.Q.SUCCESS, function(e) {
                "turbo" === e.mechanism && C.x(`${document.title}`)
            }), L.n4 ? .addEventListener(a$.INITIAL, iE.Yl), L.n4 ? .addEventListener(a$.START, e => {
                iE.LD(e.detail.mechanism)
            }), L.n4 ? .addEventListener(a$.SUCCESS, () => iE.BT()), L.n4 ? .addEventListener(a$.ERROR, () => iE.r_()), L.n4 ? .addEventListener(a$.RENDER, () => iE.TL())
        },
        47442: (e, t, n) => {
            "use strict";
            n.d(t, {
