    ...
    ["vendors-node_modules_github_file-attachment-element_dist_index_js-node_modules_github_mini-th-55cf52"], {
        57260: (e, t, n) => {
            ...
            let Attachment = class Attachment {
                ...
                static traverse(e, t) {
                    var n;
                    return t && (n = e).items && Array.from(n.items).some(e => {
                        let t = e.webkitGetAsEntry && e.webkitGetAsEntry();
                        return t && t.isDirectory
                    }) ? r("", Array.from(e.items).map(e => e.webkitGetAsEntry()).filter(e => null != e)) : Promise.resolve(i(Array.from(e.files || [])).map(e => new Attachment(e)))
                }
                static from(e) {
                    let t = [];
                    for (let n of e)
                ...
                saved(e) {
                    ...
                    this.state = "saved", this.id = null !== (t = null == e ? void 0 : e.id) && void 0 !== t ? t : null, this.href = null !== (n = null == e ? void 0 : e.href) && void 0 !== n ? n : null, this.name = null !== (i = null == e ? void 0 : e.name) && void 0 !== i ? i : null
                }
                isPending() {
            ...
            async function r(e, t) {
                let n = [];
                for (let s of i(t))
                    if (s.isDirectory) n.push(...await r(s.fullPath, await
                        function(e) {
            ...
            let FileAttachmentElement = class FileAttachmentElement extends HTMLElement {
                connectedCallback() {
                    this.addEventListener("dragenter", a), this.addEventListener("dragover", a), this.addEventListener("dragleave", l), this.addEventListener("drop", c), this.addEventListener("paste", d), this.addEventListener("change", f)
                }
                disconnectedCallback() {
                    this.removeEventListener("dragenter", a), this.removeEventListener("dragover", a), this.removeEventListener("dragleave", l), this.removeEventListener("drop", c), this.removeEventListener("paste", d), this.removeEventListener("change", f)
                }
                get directory() {
                ...
                async attach(e) {
                    ...
                    n && t.length && this.dispatchEvent(new CustomEvent("file-attachment-accepted", {
                        bubbles: !0,
                        detail: {
                            attachments: t
                        }
            ...
            function a(e) {
                ...
                o && clearTimeout(o), o = window.setTimeout(() => t.removeAttribute("hover"), 200);
                let n = e.dataTransfer;
                n && s(n) && (n.dropEffect = "copy", t.setAttribute("hover", ""), e.preventDefault())
            }
            ...
            function c(e) {
                ...
                let n = e.dataTransfer;
                n && s(n) && (t.attach(n), e.stopPropagation(), e.preventDefault())
            }
        ...
        3447: (e, t, n) => {
            ...
            function r(e = 0, t = {}) {
                return (n, r, s) => {
                    if (!s || "function" != typeof s.value) throw Error("debounce can only decorate functions");
                    let o = s.value;
        ...
        98105: (e, t, n) => {
            ...
            function r(e) {
                ...
                if (t !== n.body) {
                    for (; t !== n.body;) {
                        ...
                        if ("fixed" === e || "auto" === n || "auto" === r || "scroll" === n || "scroll" === r) break
                    }
            ...
            function s(e, t) {
                ...
                if (!s) return;
                n = s._container;
                let a = n === i.documentElement && i.defaultView ? {
            ...
            function o(e, t) {
                ...
                if (!a) return;
                let l = o.defaultView.HTMLElement,
                    c = 0,
                    u = 0,
                    d = s.offsetHeight,
                    f = s.offsetWidth;
                for (; !(s === o.body || s === t);) {
                    if (c += s.offsetTop || 0, u += s.offsetLeft || 0, !(s.offsetParent instanceof l)) return;
                    s = s.offsetParent
                }
                if (t && t !== o && t !== o.defaultView && t !== o.documentElement && t !== o.body) {
                    ...
                    var h, p;
                    r = a, n = Math.max((h = o.body).scrollHeight, a.scrollHeight, h.offsetHeight, a.offsetHeight, a.clientHeight), i = Math.max((p = o.body).scrollWidth, a.scrollWidth, p.offsetWidth, a.offsetWidth, a.clientWidth)
                }
                let m = n - (c + d),
                    v = i - (u + f);
                return {
            ...
            n.d(t, {
                e: () => function e(t, n, o) {
                    ...
                    h.signal.addEventListener("abort", () => {
                        ...
                        let i = s.findIndex(e => e.container === t);
                        i >= 0 && s.splice(i, 1),
                            function() {
                                let t = s.pop();
                        ...
                        signal: h.signal,
                        capture: !0
                    }), f(document.activeElement), i = {
                        container: t,
                        controller: h,
                        initialFocus: n,
                        originalSignal: c
                    };
                    let p = s.findIndex(e => e.container === t);
                    if (p >= 0 && s.splice(p, 1), !o) return l
                }
            });
            var r = n(78160);
            (0, n(44542).O)();
            ...
            function s() {
                i || (! function() {
                    ...
                    EventTarget.prototype.addEventListener = function(t, n, i) {
                        return "object" == typeof i && "signal" in i && i.signal instanceof AbortSignal && e.call(i.signal, "abort", () => {
            ...
            function* i(e, t = {}) {
                ...
                let r = null !== (n = t.strict) && void 0 !== n && n,
                    ...
                    l = document.createTreeWalker(e, NodeFilter.SHOW_ELEMENT, {
                        acceptNode: e => e instanceof HTMLElement && a(e, r) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
                    }),
                    c = null;
                ...
                for (; c instanceof HTMLElement;) yield c, c = t.reverse ? l.previousNode() : l.nextNode();
            ...
            function s(e, t = !1) {
                ...
                if (t) {
                    let t = getComputedStyle(e),
                        ...
                        r = "none" === t.display || !e.offsetParent,
                        s = 0 === e.getClientRects().length;
                    if (n || i || s || r) return !1
                }
        ...
        59753: (e, t, n) => {
            ...
            var r, s = window.document.documentElement,
                o = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector;
            ...
            function d(e, t) {
                var n, i, r, s, o, a, l = (e = e.slice(0).concat(e.default)).length,
                    c = t,
                    d = [];
                do
            ...
            i.prototype.logDefaultIndexUsed = function() {}, i.prototype.add = function(e, t) {
                var n, i, s, o, a, l, c, u, f = this.activeIndexes,
                    h = this.selectors,
                ...
                if ("string" == typeof e) {
                    for (i = 0, p[(n = {
                            ...
                            selector: e,
                            data: t
                        }).id] = n, c = d(this.indexes, e); i < c.length; i++) o = (u = c[i]).key, (a = function(e, t) {
                        var n, i, r;
                        for (n = 0, i = e.length; n < i; n++)
                            if (r = e[n], t.isPrototypeOf(r)) return r
                    }(f, s = u.index)) || ((a = Object.create(s)).map = new r, f.push(a)), s === this.indexes.default && this.logDefaultIndexUsed(n), (l = a.map.get(o)) || (l = [], a.map.set(o, l)), l.push(n);
                    this.size++, h.push(e)
                }
            }, i.prototype.remove = function(e, t) {
                if ("string" == typeof e) {
                    var n, i, r, s, o, a, l, c, u = this.activeIndexes,
                        f = this.selectors = [],
                        ...
                        for (i = n[r], s = u.length; s--;)
                            if (a = u[s], i.index.isPrototypeOf(a)) {
                                if (l = a.map.get(i.key))
                                    for (o = l.length; o--;)(c = l[o]).selector === e && (m || c.data === t) && (l.splice(o, 1), p[c.id] = !0);
                                break
                            }
                ...
                for (t = 0, i = d.length; t < i; t++)
                    for (n = 0, s = d[t], r = (o = this.matches(s)).length; n < r; n++) c[(l = o[n]).id] ? a = c[l.id] : (a = {
                        id: l.id,
                        selector: l.selector,
                        data: l.data,
                        elements: []
                    }, c[l.id] = a, u.push(a)), a.elements.push(s);
                return u.sort(f)
            }, i.prototype.matches = function(e) {
                if (!e) return [];
                var t, n, i, r, s, o, a, l, c, u, d, h = this.activeIndexes,
                    p = {},
                    m = [];
                for (t = 0, r = h.length; t < r; t++)
                    if (l = (a = h[t]).element(e)) {
                        for (n = 0, s = l.length; n < s; n++)
                            if (c = a.map.get(l[n]))
                                for (i = 0, o = c.length; i < o; i++) !p[d = (u = c[i]).id] && this.matchesSelector(e, u.selector) && (p[d] = !0, m.push(u))
                    }
                return m.sort(f)
            };
            var h = {},
            ...
            function T(e) {
                if (function(e) {
                    ...
                    if (t) {
                        ...
                        if (n.length) {
                            y(e, "stopPropagation", E), y(e, "stopImmediatePropagation", A), x(e, w);
                            for (var i = 0, r = n.length; i < r && !m.get(e); i++) {
                                var s = n[i];
                                g.set(e, s.node);
                                for (var o = 0, a = s.observers.length; o < a && !v.get(e); o++) s.observers[o].data.call(s.node, e)
                            }
                            g.delete(e), x(e)
                        }
                    }
            ...
            function k(e, t, n) {
                var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                    ...
                    o = s ? p : h,
                    a = o[e];
                a || (a = new i, o[e] = a, document.addEventListener(e, T, s)), a.add(t, n)
            }
            ...
            function L(e, t, n) {
                var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                    ...
                    s = r ? p : h,
                    o = s[e];
                o && (o.remove(t, n), o.size || (delete s[e], document.removeEventListener(e, T, r)))
            }
        ...
        11793: (e, t, n) => {
            ...
            let RadixTrie = class RadixTrie {
                ...
                insert(e) {
                    ...
                    for (let n = 0; n < e.length; n += 1) {
                        let i = e[n],
                            r = t.get(i);
                        if (n === e.length - 1) return r instanceof RadixTrie && (t.delete(r), r = null), r || (r = new Leaf(t), t.children[i] = r), r;
                        r instanceof Leaf && (r = null), r || (r = new RadixTrie(t), t.children[i] = r), t = r
                    }
                    return t
                }
                delete(e) {
            ...
            function o(e, t = navigator.platform) {
                ...
                for (let [e, t] of [u, d, f, h].entries()) t && m.push(a[e]);
                if (!a.includes(p)) {
                    let e = m.includes("Alt") && c.test(t) && null !== (n = i[p]) && void 0 !== n ? n : p,
                        a = m.includes("Shift") && c.test(t) && null !== (o = r[e]) && void 0 !== o ? o : e,
                        u = null !== (l = s[a]) && void 0 !== l ? l : a;
                    m.push(u)
                }
                return m.join("+")
            }
                ...
                if (m.registerKeypress(e), p = t, t instanceof Leaf) {
                    ...
                    n && r && (function(e, t) {
                        let n = new CustomEvent("hotkey-fire", {
                            ...
                            i = !e.dispatchEvent(n);
                        i || (d(e) ? e.focus() : e.click())
                    }(n, m.path), e.preventDefault()), m.reset()
                }
            }

            function g(e, t) {
                0 === Object.keys(f.children).length && document.addEventListener("keydown", v);
                let n = function(e) {
                        let t = [],
                            n = [""],
                            i = !1;
                        ...
                        return t.push(n), t.map(e => e.map(e => l(e)).filter(e => "" !== e)).filter(e => e.length > 0)
                    }(t || e.getAttribute("data-hotkey") || ""),
                    i = n.map(t => f.insert(t).add(e));
                h.set(e, i)
            }
            ...
            function b(e) {
                ...
                0 === Object.keys(f.children).length && document.removeEventListener("keydown", v)
            }
        }
    }
]);
